...
* You have up to one hour to log a punishment. Users who are occupied with a session will have extended time so long they log it asap. It is highly recommended that (unless your busy with a session) you log asap.
  * You are required to add BC comments for in-game punishments within five minutes of them being issued to ensure infractions are properly counted.

---

# **Punishment Checklist**
* What infraction is the user on?
* How many times has the user recieved an infraction for this rule?
...
* What is the punishment based on their history and current infractions? Considering only valid history.
...
## **Punishment Type Infraction Information**
* Punishment type infractions are separate from normal infractions.  
* Each punishment type has its own infraction count.  
* For example, if someone has 2 mutes and you are about to issue the 3rd mute punishment, the 3rd mute would be 1 day in length.  
...
## **Team Bans**
Automatically determined by the in-game punishment panel. CAC+.
